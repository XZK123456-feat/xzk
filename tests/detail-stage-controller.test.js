...
assert.deepStrictEqual(plain(state.parseState("#horizontal-p2", ["overview", "horizontal"])), { view: "horizontal", page: 2 });
assert.deepStrictEqual(plain(state.parseState("#unknown-p4", ["overview", "horizontal"])), { view: "overview", page: 1 });
assert.deepStrictEqual(plain(state.parseState("#horizontal-p0", ["overview", "horizontal"])), { view: "horizontal", page: 1 });
assert.deepStrictEqual(plain(state.parseState(null, ["overview"], "overview")), { view: "overview", page: 1 });
assert.strictEqual(state.formatState({ view: "horizontal", page: 2 }), "#horizontal-p2");
assert.deepStrictEqual(plain(state.reduceState({ view: "overview", page: 1 }, { type: "SELECT_VIEW", view: "horizontal" }, { horizontal: 3 })), { view: "horizontal", page: 1 });
assert.deepStrictEqual(plain(state.reduceState({ view: "horizontal", page: 1 }, { type: "SET_PAGE", page: 99 }, { horizontal: 3 })), { view: "horizontal", page: 3 });
assert.deepStrictEqual(plain(state.reduceState({ view: "horizontal", page: 2 }, { type: "NEXT_PAGE" }, { horizontal: 3 })), { view: "horizontal", page: 3 });
assert.deepStrictEqual(plain(state.reduceState({ view: "horizontal", page: 2 }, { type: "PREVIOUS_PAGE" }, { horizontal: 3 })), { view: "horizontal", page: 1 });
assert.deepStrictEqual(plain(state.reduceState({ view: "horizontal", page: -4 }, { type: "UNKNOWN" }, { horizontal: 3 })), { view: "horizontal", page: 1 });
